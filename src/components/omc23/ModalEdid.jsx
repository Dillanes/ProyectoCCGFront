    ...
    <div className='modalContainer'>
       ...
       <div className="row mt-2">
        <div className="form-group col-sm-12 mt-2 col-md-6">
         ...
         <input type="text" maxLength='9' className="form-control" id="inputEmail4" {...register("codigo",{required:true, maxLength:9})} placeholder="Código"/>
     ...
     {props.numeroTabla>1? (
       <div className="custom-control col-sm-12 mt-2 col-md-6 custom-checkbox">
