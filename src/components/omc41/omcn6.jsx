     ...
     return(
      <div className='containerTable mt-4'>
        <div className='headerTable' >
          <div className='col-md-5 col-lg-6 col-sm-4' ><h2 className='mt-3 textTable'>OMC Nivel 6</h2></div>
          <div className='col-md-5 col-lg-5 col-sm-7'><GlobalFilter filter={globalFilter} setFilter={setGlobalFilter}/></div><button className='btn btn-dark  m-3' onClick={()=>props.active(true,6,selectcodigo5)}>Registrar</button>
          </div>
