  ...
  return (
    <div className={name}>
      ...
      <ul className='navAside'>
        ...
        <li className='ListItems' onClick={()=>props.createReciveTable(4)}><div className='asideText'>Nivel4</div></li>
        <li className='ListItems' onClick={()=>props.createReciveTable(5)}><div className='asideText'>Nivel5</div></li>
        <li className='ListItems' style={{borderRadius:'0px 0px 0px 8px'}} onClick={()=>props.createReciveTable(6)}><div className='asideText'>Nivel6</div></li>
