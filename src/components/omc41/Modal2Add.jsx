  ...
  return (
    <Fragment>
        ...
        <div className='modalContainer'>
            <button className='closeBtn'  onClick={()=>{props.setactive(false);props.setselect(null);reset();props.setShowT(false)}}>X</button>
       ...
       {props.select!=null || props.numeroTabla===1?(
        <div className='form' style={props.numeroTabla===1 || props.showT === true ?{marginTop:'40px'}:null}>
    ...
    <div className='modal-backdrop fade show' style={{zIndex:400}}></div>
