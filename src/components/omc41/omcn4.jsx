   ...
   const tableHooks = (hooks)=>{
    hooks.visibleColumns.push((columns)=>[
      ...columns,{
        ...
        Header:'Editar',
        Cell:({row})=>(
          <button type='button' style={{marginTop:'20%'}} className='btn btn-success'  onClick={()=>props.edidrow(4,row.values)}> Editar</button>
    ...
    setGlobalFilter,
     ...
     return(
      <div className='containerTable mt-4'>
          ...
          <div className='col-md-5 col-lg-6 col-sm-4' ><h2 className='mt-3 textTable'>OMC Nivel 4</h2></div>
          <div className='col-md-5 col-lg-5 col-sm-7'><GlobalFilter filter={globalFilter} setFilter={setGlobalFilter}/></div><button className='btn btn-dark  m-3' onClick={()=>props.active(true,4,selectcodigo3)}>Registrar</button>
          </div>
